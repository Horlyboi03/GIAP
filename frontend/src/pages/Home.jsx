...
export default function Home() {
  ...
  useEffect(() => {
    api.get('/grants/categories').then(res => setCategories(res.data))
    api.get('/grants/faqs').then(res => setFaqs(res.data))
    api.get('/grants/testimonials').then(res => setTestimonials(res.data))
  }, [])
